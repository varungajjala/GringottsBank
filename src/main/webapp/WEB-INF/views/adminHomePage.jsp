  						...
  						<div class="form-group">
    						<label for="username" class="col-sm-2 control-label">First Name</label>
    							<div class="col-sm-8">
    								<div class="input-group">
  										<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>      									
      									<form:input path="firstName" type="text" class="form-control" id="lastName" placeholder="Firstname" required="true" maxlength="16"/>
      								</div>
    							</div>
  						</div>
  						<div class="form-group">
    						<label for="username" class="col-sm-2 control-label">Last Name</label>
    							<div class="col-sm-8">
    								<div class="input-group">
  										<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
      									<form:input path="lastName" type="text" class="form-control" id="firstName" placeholder="Lastname" required="true" maxlength="20"/>
      								</div>
    							</div>
  						</div>
  						<div class="form-group">
  						...
  						<div class="form-group">
    						<label for="inputContact" class="col-sm-2 control-label">User Type</label>
    							<div class="col-sm-8">
    								<div class="input-group">
										<label for="singleUser">
						    				<form:radiobutton path ="utype" checked="true" id="internalUser" name="chkUserType" value="internalUser" required="true"/>
						    				Internal User  
										</label>
										<label for="chkNo">
