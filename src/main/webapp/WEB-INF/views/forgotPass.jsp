  		...
  		<div class="col-md-6" style="padding-top: 40px">
  			<div class="panel panel-default" style="background: #eee">
  				<div class="panel-body" >
    				...
    				<form:form class="form-horizontal" action = "registrationSuccessful" commandName="forgotPassword" method="POST">
  						...
  						<div class="form-group">
    						<label for="password" class="col-sm-2 control-label">Password</label>
    							<div class="col-sm-8">
    								<div class="input-group">
  										<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
      									<form:input path="passwd" type="text" class="form-control" id="inputPassword" placeholder="Password"/>
      								</div>
    							</div>
  						</div>
